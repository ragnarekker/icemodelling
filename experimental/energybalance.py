...
class EnergyBalanceElement:
    ...
    def add_model_input(self, utm33_x_inn, utm33_y_inn, snow_depth_inn, snow_density_inn,
        ...
        """Method that adds all modelling resources to the object for easy access later."""
...
def get_albedo_ueb(prec_snow, snow_depth, temp_surface, zenith_angle, time_span_in_sec, age_factor_tau=None):
    ...
    ##TEST VARIABLE som er resources
...
def get_turbulent_flux(
    ...
    if method == "YOU 2014":
        ...
        print("energybalance.py -> get_turbulent_flux: No valid method given.")
